...
* st_name: 0x00 - 0x03 байты: 
        ...
        Строковое представление имени находится по индексу 1 по таблице строк .strtab. 
        Давайте проверим:
...
5) Перейдем к записи соответствующей extern функции.
 ...
 * st_value: 0x08 - 0x0F байты:
        ...
        st_value = 0x00. Extern функция не имеет адреса, где бы она была определена.
