...
*(Автор очень сильно перегорел, пытаясь разобраться в этом дерьме с документацией времён полеозоя, которую при этом хер достанешь, поэтому единственное, что может повлиять на доработку этого гайда, это материальные блага (А именно: Lenovo ThinkPad X1 Carbon Gen 9 с разрешением экрана UHD+). А что вы хотели, автор потерял много нервов, пока писал этот гайд.)*
