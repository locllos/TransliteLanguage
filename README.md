...
- [Собираем свой **object elf64 file**](#собираем-свой-object-elf64-file)
  ...
  - [6. Relatext entry](#6-relatext-entry)
    ...
    - [Пример записей реалокации](#пример-записей-реалокации)
...
* r_info: 0x08 - 0x0F байты:
        ...
        написав в терминале readelf -r -W res/examples/test.o), мы увидим, что запись перемещения соответствует функции _sqrt.
...
На основе самого подробного(в сравнении с остальными гайдами(ах да, их же нет)) примера объектного файла и описания секций, теперь можно начать писать свой объектный файл. 
